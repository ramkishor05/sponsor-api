...
@Entity
@Table(name = EOUserSponsorLevelTransaction.USER_SPONSOR_LEVEL_TRANSACTION)
public class EOUserSponsorLevelTransaction extends EOEntityObject {

	static final String USER_SPONSOR_LEVEL_TRANSACTION = "USER_SPONSOR_LEVEL_TRANSACTION";
	/**
	 * 
	 */
